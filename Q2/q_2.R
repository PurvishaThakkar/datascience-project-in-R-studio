...
header=c("state.ut","district","Rape","Kidnapping.and.Abduction","Dowry.Deaths","Assault.on.women.with.intent.to.outrage.her.modesty","Insult.to.modesty.of.Women","cruelty.by.Husband.or.his.Relatives","Importation")
print(header)
df11=data.frame(header)
print(df11)
